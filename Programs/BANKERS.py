...
allocated = np.array([[4,0,0,1],[1,1,0,0],[1,2,5,4],[0,6,3,3],[0,2,1,2]]) #2D ARRAY
maximum = np.array([[6,0,1,2],[1,7,5,0],[2,3,5,6],[1,6,5,3],[1,6,5,6]]) #3D ARRAY

needed = maximum - allocated

available = np.array([3,2,1,1]) #1D ARRAY
count = 0
